// @ts-nocheck
// Original algorithm: https://github.com/robatron/sudoku.js
...
type Library = {
  generate: (difficulty: number, unique: boolean) => string;
  solve: (board: string, reverse: boolean) => string | false;

  board_string_to_grid: (board: string) => Board;
  board_grid_to_string: (board: Board) => string;
};

export const library: Library = (function (root) {
